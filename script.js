...
const weapons = [
  ...
  { name: 'axe', power: 150 },
  { name: 'magic staff', power: 200 },
  { name: 'excalibur', power: 300 }
];
...
const monsters = [
  ...
  { name: "fanged beast", level: 8, health: 60, image: "images/fanged_beast.webp" },
  ...
  { name: "dark wizard", level: 25, health: 350, image: "images/dark_wizard.webp" }
];
...
const locations = [
  ...
  {
    name: "store",
    "button text": ["Buy 10 health (10 gold)", "Buy a weapon", "Return to town square"],
    "button functions": [buyHealth, buyWeapon, goTown],
    text: "You enter the shop."
  },
  {
    name: "cave",
    "button text": ["Fight a slime", "Fight a fanged beast", "Return to town square"],
  ...
  {
    name: "castle",
    "button text": ["Fight the dragon", "Fight the dark wizard", "Return to town square"],
    "button functions": [fightDragon, fightDarkWizard, goTown],
    text: "You enter the castle, it's dark and silent."
  }
];

// Game button initialization and starting the game
...
function buyWeapon() {
  if (currentWeapon < weapons.length - 1) {
    ...
    button2.innerText = "Sell weapon for " + (weaponPrices[currentWeapon] / 2) + " gold";
...
function sellWeapon() {
  if (inventory.length > 1) {
    ...
    gold += sellPrice;
    goldText.innerText = gold;
    text.innerText = "You sold a " + soldWeapon + " for " + sellPrice + " gold.";
    currentWeapon--;
    text.innerText += " In your inventory, you have: " + inventory.join(", ") + ".";
  } else {
...
function attack() {
  ...
  if (isMonsterHit()) {
    ...
    text.innerText += " You deal " + damage + " damage to the " + monsters[fighting].name + ".";
  } else {
